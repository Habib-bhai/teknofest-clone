    ...
    <>
      ...
      <div className="w-[90vw] h-[120vh] flex flex-wrap md:flex-nowrap justify-center items-center">
        ...
        <div>
          ...
          <h3 className="text-2xl text-blue-700 mx-3">OVERVIEW</h3>

          <h1 className="text-3xl font-bold font-['Poppins']  text-blue-950 mt-2 mx-3">GET THE LATEST INFO ABOUT <span className="text-green-700"><br />TEKNOFEST</span>  </h1> <br />
        ...
        <div className="grid grid-cols-2 gap-6 lg:w-1/2 mt-10 lg:mt-0 relative ">
          <img src={image1} alt="img1" className="rounded-lg shadow-lg w-50 h-50 object-cover " />
          <img src={image2} alt="img2" className="rounded-lg shadow-lg w-full h-auto object-cover" />
          <img src={image3} alt="img3" className="rounded-lg shadow-lg w-full h-auto object-cover" />
        </div>
      </div>
      ...
      <div className=" flex flex-col items-center mt-10">
        ...
        <div className="grid grid-cols-2 gap-8 lg:w-1/2 mt-10 lg:mt-0 ">
          ...
          <div className="bg-slate-100 rounded-lg shadow-lg p-5 flex flex-col items-center">
            ...
            <h2 className="text-3xl font-bold text-blue-900">GRAB YOUR PASS</h2>
