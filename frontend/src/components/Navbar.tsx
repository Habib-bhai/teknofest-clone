        ...
        <>
            ...
            <nav id='navbar' className="absolute top-0 left-0 w-full flex items-center justify-center p-8 lg:px-8  text-green-700  z-10 ">
                ...
                <div className='flex items-center space-x-1 bg-white border-2 border-green-700 rounded-md full p-1 ml-9 w-15'>
                    ...
                    <div className='absolute right-60 top-20 transform translate-x-1/2 -translate-y-1/2 bg-red-600 text-pink-50 text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full'>{cartCount}</div>
                    </a>
                    </div>
