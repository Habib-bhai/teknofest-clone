        ...
        <>
            ...
            <div className="md:px-40">
                ...
                <div className="flex justify-center items-center gap-3 mt-10">
                    ...
                    <img src="/facebook.png" alt="" className="w-10 h-10 p-3 bg-white/40 rounded-full hover:bg-[#388636]" />
                    <img src="/instagram.png" alt="" className="w-10 h-10 p-3 bg-white/40 rounded-full hover:bg-[#388636]" />
                    <img src="youtube.png" alt="" className="w-10 h-10 p-3 bg-white/40 rounded-full hover:bg-[#388636]" />
                    <img src="linkedin.png" alt="" className="w-10 h-10 p-3 bg-white/40 rounded-full hover:bg-[#388636]" />
                </div>
